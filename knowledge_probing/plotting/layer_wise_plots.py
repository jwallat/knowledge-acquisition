...
def produce_layer_wise_plots(orderType):
    ...
    data_dir = 'data/layer_data/classifier_per_layer/long_e100_p15_d0_01/new_decoder/'

    with open('{}1/default_data.json'.format(data_dir)) as json_data:
            ...
            for metric in ['P_AT_1', 'P_AT_10', 'P_AT_K']:
                ...
                if orderType == 'None':
                    ...
                    if not os.path.exists("{}plots/png_naive_ordering/".format(data_dir)):
                        os.mkdir("{}plots/png_naive_ordering/".format(data_dir))
    ...
    if orderType == 'clustering':
        ...
        if not os.path.exists("{}plots/png_clustered/".format(data_dir)):
            os.mkdir("{}plots/png_clustered/".format(data_dir))
